 ...
 */
function renderTemplateBoardColumn(i, parameter, parameterCounter) {
    return `<div class="board-column flex column">
                <div class="board-column-header flex cursor-p">
                    <p>${boardColumnTitle[i]}</p>
                    <div class="board-column-header-plus flex" onclick="openBoardAddtaskPopup('${parameter}', '${parameterCounter}')">+</div>
                </div>
